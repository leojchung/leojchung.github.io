...
(function () {
  ...
  /* ── Vancouver's current weather ─────────────────────────────────────────
     ...
     visitor. Every failure path leaves the card exactly as it was rendered
     — an em dash and no condition line, rather than stale or wrong numbers. */
